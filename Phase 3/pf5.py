...
class ParticleFilter:
    def __init__(self, num_particles, map_polygons, map_bounds):
        ...
        self.motion_noise_x = 0.00001
        self.motion_noise_theta = 0.001
        self.sensor_noise_std = 0.0001
...
class LocalizationNode:
    def __init__(self):
        ...
        self.world_file_path = rospy.get_param('~world_file', "/home/user/catkin_ws/src/anki_description/world/sample1.world")
        self.num_particles = rospy.get_param('~num_particles', 800)
        self.convergence_threshold = rospy.get_param('~convergence_threshold', 0.0002)
        ...
        self.map_bounds = (min(all_x)-0.05, max(all_x)+0.05, min(all_y)-0.5, max(all_y)+0.1)
