...
class ParticleFilter:
    ...
    def resample(self):
        ...
        threshold = self.num_particles * 0.25  # resample threshold
        ...
        if N_eff < threshold:
            # --- AMCL-style adaptive injection ---
            rospy.logwarn("Kidnapping suspected! Performing adaptive resampling.")

            # Define adaptive injection ratio based on how low Neff is
            min_injection_ratio = 0.05  # inject at least 5% random
            max_injection_ratio = 0.5   # inject at most 50% random

            # Compute injection ratio linearly scaled based on Neff
