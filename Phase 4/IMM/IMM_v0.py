...
def odom_callback(data):
   global robot_position, current_robot_vel_cmd
   ...
   current_robot_vel_cmd = data.twist.twist.linear.x
   robot_position["x"] = data.pose.pose.position.x+np.random.normal(0.0008,0.000015)
   robot_position["y"] = data.pose.pose.position.y+np.random.normal(0.0008,0.000015)
